  ...
  return (
    ...
    >
      <div className="w-full relative">
        ...
        <div
          className="absolute top-0 left-0 w-full h-1 bg-[#00ffaa]/30 z-10 pointer-events-none animate-[scan-line_4s_linear_infinite]"
        />

        <div className="text-center">
          <div className="animate-[rise_0.8s_ease_forwards] opacity-0">
          ...
          {/* Availability Status */}
          <div className="animate-[rise_0.6s_ease_0.35s_forwards] opacity-0 flex justify-center mb-6">
          ...
          {/* Role Badges */}
          <div
            className="flex flex-wrap justify-center gap-4 text-sm font-mono opacity-0 animate-[fade-in_0.5s_ease_0.5s_forwards]"
          >
          ...
          {/* Description */}
          <div
            className="mt-12 max-w-2xl mx-auto p-4 border-l-4 border-[#ffae00] bg-[#ffae00]/5 text-left origin-left animate-[scale-x_0.6s_ease_0.8s_forwards] scale-x-0"
          >
          ...
          {/* CTAs */}
          <div
            className="mt-12 md:mt-16 flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 opacity-0 animate-[rise_0.5s_ease_1s_forwards]"
          >
            <button
      ...
      {/* Scroll Indicator */}
      <button
        className="mt-16 flex flex-col items-center gap-2 opacity-40 hover:opacity-80 transition-opacity cursor-pointer focus-visible:opacity-80 animate-[bounce-y_2s_ease-in-out_infinite]"
        onClick={scrollToMissions}

...
import mbsImage from "@/assets/MBS.webp";
import ohBuildsImage from "@/assets/OHBuilds.webp";
import HabitTracker from "@/assets/HabitTracker.webp";
...
function MissionCard({ mission, index }: { mission: typeof missions[0]; index: number }) {
  ...
  return (
    <div
      ref={ref}
      className={`corner-frame bg-[#00ffaa]/5 group hover:bg-[#00ffaa]/10 transition-all duration-500 ${
